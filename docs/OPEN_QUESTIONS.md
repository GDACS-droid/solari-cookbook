...
| --- | --- | --- | --- |
| P0 | Which Lee Clerk route and agreement permits production event detection? | determines live data legality/reliability | obtain current bulk/FTP agreement and written guidance |
...
| P0 | Is the redacted 3302 E 3rd St fixture and generic-portal-only replay acceptable for the public launch? | avoids gratuitous personal-data publication while preserving a real case | complete privacy/legal launch review; keep property-specific sessions unrecorded |
